  ...
  return (
    <div className="w-full overflow-x-hidden">
      <div className=" w-full">
        <div className="overflow-x-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-[#181818] flex gap-x-8 sm:w-[100rem] scroll-smooth relative  sm:min-w-[70rem] mt-12 sm:mt-1">
