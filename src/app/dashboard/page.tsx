...
const dashboardItems = [
  { id: 'dashboard', text: 'Total Courses', count: 25, IconComponent: BiBookOpen, borderStyle: '#F8AF43', backgrounndStyle: '#F8AF4326', curvesColor: '#F8AF43', borderColor: '#F8AF4326' },
  { id: 'courses', text: 'Total Microlearning', count: 11, IconComponent: BiBook, borderStyle: '#9747FF', backgrounndStyle: '#9747FF26', curvesColor: '#9747FF', borderColor: '#9747FF26' },
    ...
    <div className='w-full !p-8 '>
      ...
      <div className='grid sm:grid-cols-3 gap-x-8 !w-full  gap-y-3'>
        {dashboardItems.map((item) => {
          ...
          const topCurves = (
            <svg width="75" height="61" viewBox="0 0 75 61" fill="none" xmlns="http://www.w3.org/2000/svg" className='!w-auto !h-auto absolute top-0 left-0'>
              <g opacity="0.3">
          ...
          const bottomCurves = (
            <svg width="91" height="40" viewBox="0 0 91 40" fill="none" xmlns="http://www.w3.org/2000/svg" className='!w-auto !h-auto absolute top-0 right-0'>
              <g opacity="0.3">
                <path d="M2.5 39.5C20.1667 29.8333 62.2 14 89 28" stroke={item.curvesColor} />
                <path d="M0.5 39.5C9.16667 19.3333 39.3 -14.9 90.5 9.5" stroke={item.curvesColor} />
              </g>
            </svg>
          )
          ...
          return (
            <div key={item.id} className={`rounded-[1.2rem] !border  inline-block z-10`} style={{ backgroundColor: item.backgrounndStyle, borderColor: item.borderStyle }}>
              ...
              <div className={`!border-t !border-t-[${item.borderColor}] flex justify-between text-white !p-4 relative overflow-hidden w-full`} style={{ borderTopColor: item.borderColor }}>
