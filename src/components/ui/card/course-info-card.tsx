    ...
    <div className="flex items-center justify-between bg-[#222222]  !px-6 !py-5 rounded-2xl w-full shadow-md hover:bg-zinc-800 transition">
      <div className="flex items-center gap-6 max-w-[55%]">
        ...
        <div className="flex flex-col">
          <h3 className="font-['comfortaa'] text-text-secondary font-[600] text-[1.13rem]  leading-snug !mb-2">{title}</h3>
      ...
      <div className="flex items-center gap-14 text-base whitespace-nowrap">
        <div className="flex items-center gap-2">
          ...
          <span className="font-['open_sans'] text-text-secondary  font-[600] text-[0.8rem]">{instructor}</span>
        </div>
        <span className="font-['open_sans'] text-text-secondary  font-[600] text-[0.8rem]">{lessonsCount} lessons</span>
        <span className="font-['open_sans'] text-text-secondary  font-[600] text-[0.8rem]">{date}</span>
      </div>
    </div>
  );
};
