...
const CourseInfoCard: FC<CourseCardProps> = ({
  ...
  return (
    <div className="flex items-center justify-between bg-[#222222] text-white !px-6 !py-5 rounded-2xl w-full shadow-md hover:bg-zinc-800 transition">
      <div className="flex items-center gap-6 max-w-[55%]">
        <div className="w-30 h-30 relative rounded-xl overflow-hidden shrink-0">
      ...
      <div className="flex items-center gap-14 text-base whitespace-nowrap">
        ...
        <span className="font-opensans text-[#ffff] font-[600] text-[0.8rem]">{lessonsCount} lessons</span>
        <span className="font-opensans text-[#ffff] font-[600] text-[0.8rem]">{date}</span>
      </div>
    </div>
  );
};
