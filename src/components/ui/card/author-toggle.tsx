    ...
    <div>
      <div className='relative'>
        <div className='flex gap-x-4 items-center mt-10'>
          ...
          <FaChevronDown color='white' width={12} height={7} onClick={() => handleToggle()} style={{ display: !isAuthorVisible ? 'block' : 'none' }}/>
            <FaChevronUp color='white' width={12} height={7} onClick={() => handleToggle()} style={{ display: isAuthorVisible ? 'block' : 'none' }}/>
        </div>

        <div className='absolute flex-col gap-x-4  mt-2 bg-[#222222] rounded-[0.8rem] p-3 inline-flex' style={{ display: isAuthorVisible ? 'flex' : 'none' }}>
          ...
          <div className='h-7 mt-2'>
            <FaRegEyeSlash color="gray" width={20} height={20} className='inline-block mr-4 text-gray-500' />
