...
var jt = "4.1.3";
var Ee = 92, Le = 47, Me = 42, di = 34, mi = 39, gi = 58, We = 59, me = 10, Re = 32, Be = 9, It = 123, gt = 125, wt = 40, Ft = 41, hi = 91, vi = 93, zt = 45, ht = 64, wi = 33;
function ge(t) {
    t[0] === "\uFEFF" && (t = t.slice(1)), t = t.replaceAll(`\r
`, `
`);
    let r = [], i = [], e = [], n = null, s = null, a = "", f = "", u;
    for(let c = 0; c < t.length; c++){
        let g = t.charCodeAt(c);
        if (g === Ee) a += t.slice(c, c + 2), c += 1;
        else if (g === Le && t.charCodeAt(c + 1) === Me) {
            let m = c;
            for(let v = c + 2; v < t.length; v++)if (u = t.charCodeAt(v), u === Ee) v += 1;
            else if (u === Me && t.charCodeAt(v + 1) === Le) {
                c = v + 1;
                break;
            }
            let h = t.slice(m, c + 1);
            h.charCodeAt(2) === wi && i.push(qe(h.slice(2, -2)));
        } else if (g === mi || g === di) {
            let m = c;
            for(let h = c + 1; h < t.length; h++)if (u = t.charCodeAt(h), u === Ee) h += 1;
            else if (u === g) {
                c = h;
                break;
            } else {
                if (u === We && t.charCodeAt(h + 1) === me) throw new Error(`Unterminated string: ${t.slice(m, h + 1) + String.fromCharCode(g)}`);
                if (u === me) throw new Error(`Unterminated string: ${t.slice(m, h) + String.fromCharCode(g)}`);
            }
            a += t.slice(m, c + 1);
        } else {
            if ((g === Re || g === me || g === Be) && (u = t.charCodeAt(c + 1)) && (u === Re || u === me || u === Be)) continue;
            if (g === me) {
                if (a.length === 0) continue;
                u = a.charCodeAt(a.length - 1), u !== Re && u !== me && u !== Be && (a += " ");
            } else if (g === zt && t.charCodeAt(c + 1) === zt && a.length === 0) {
                let m = "", h = c, v = -1;
                for(let A = c + 2; A < t.length; A++)if (u = t.charCodeAt(A), u === Ee) A += 1;
                else if (u === Le && t.charCodeAt(A + 1) === Me) {
                    for(let b1 = A + 2; b1 < t.length; b1++)if (u = t.charCodeAt(b1), u === Ee) b1 += 1;
                    else if (u === Me && t.charCodeAt(b1 + 1) === Le) {
                        A = b1 + 1;
                        break;
                    }
                } else if (v === -1 && u === gi) v = a.length + A - h;
                else if (u === We && m.length === 0) {
                    a += t.slice(h, A), c = A;
                    break;
                } else if (u === wt) m += ")";
                else if (u === hi) m += "]";
                else if (u === It) m += "}";
                else if ((u === gt || t.length - 1 === A) && m.length === 0) {
                    c = A - 1, a += t.slice(h, A);
                    break;
                } else (u === Ft || u === vi || u === gt) && m.length > 0 && t[A] === m[m.length - 1] && (m = m.slice(0, -1));
                let w = vt(a, v);
                if (!w) throw new Error("Invalid custom property, expected a value");
                n ? n.nodes.push(w) : r.push(w), a = "";
            } else if (g === We && a.charCodeAt(0) === ht) s = Oe(a), n ? n.nodes.push(s) : r.push(s), a = "", s = null;
            else if (g === We && f[f.length - 1] !== ")") {
                let m = vt(a);
                if (!m) throw a.length === 0 ? new Error("Unexpected semicolon") : new Error(`Invalid declaration: \`${a.trim()}\``);
                n ? n.nodes.push(m) : r.push(m), a = "";
            } else if (g === It && f[f.length - 1] !== ")") f += "}", s = M(a.trim()), n && n.nodes.push(s), e.push(n), n = s, a = "", s = null;
            else if (g === gt && f[f.length - 1] !== ")") {
                if (f === "") throw new Error("Missing opening {");
                if (f = f.slice(0, -1), a.length > 0) if (a.charCodeAt(0) === ht) s = Oe(a), n ? n.nodes.push(s) : r.push(s), a = "", s = null;
                else {
                    let h = a.indexOf(":");
                    if (n) {
                        let v = vt(a, h);
                ...
                let m = e.pop() ?? null;
                m === null && n && r.push(n), n = m, a = "", s = null;
            } else if (g === wt) f += ")", a += "(";
            else if (g === Ft) {
                if (f[f.length - 1] !== ")") throw new Error("Missing opening (");
                f = f.slice(0, -1), a += ")";
            } else {
                if (a.length === 0 && (g === Re || g === me || g === Be)) continue;
                a += String.fromCharCode(g);
            }
        }
    }
    if (a.charCodeAt(0) === ht && r.push(Oe(a)), f.length > 0 && n) {
...
var He = class {
    ...
    #t(r) {
        ...
        if (!i) return null;
        let e = null;
        return i.options & 2 && (e = i.value), `var(${ue(this.prefixKey(r))}${e ? `, ${e}` : ""})`;
    }
    markUsedVariable(r) {
...
var Wt = 92, bi = 41, Bt = 58, qt = 44, xi = 34, Ht = 61, Gt = 62, Yt = 60, Jt = 10, Ai = 40, Ci = 39, Qt = 47, Zt = 32, Xt = 9;
function H(t) {
    t = t.replaceAll(`\r
`, `
`);
...
function M(t, r = []) {
    return t.charCodeAt(0) === $i ? Oe(t, r) : F(t, r);
}
function l(t, r, i = !1) {
    return {
        kind: "declaration",
...
function I(t, r, i = [], e = {}) {
    for(let n = 0; n < t.length; n++){
        ...
        let f = !1, u = 0, c = r(s, {
            ...
            path: i,
            replaceWith (g) {
                f || (f = !0, Array.isArray(g) ? g.length === 0 ? (t.splice(n, 1), u = 0) : g.length === 1 ? (t[n] = g[0], u = 1) : (t.splice(n, 1, ...g), u = g.length) : (t[n] = g, u = 1));
            }
        }) ?? 0;
        if (i.pop(), f) {
            c === 0 ? n-- : n += u - 1;
...
function Ye(t, r, i = [], e = {}) {
    for(let n = 0; n < t.length; n++){
        let s = t[n], a = i[i.length - 1] ?? null;
        if (s.kind === "rule" || s.kind === "at-rule") i.push(s), Ye(s.nodes, r, i, e), i.pop();
...
function ve(t, r, i = 3) {
    let e = [], n = new Set, s = new q(()=>new Set), a = new Set, f = new Set, u = [], c = [], g = new q(()=>new Set);
    function m(v, w, A = {}, b1 = 0) {
        if (v.kind === "declaration") {
            ...
            if (v.value.includes("var(")) if (A.theme && v.property[0] === "-" && v.property[1] === "-") for (let y of Ge(v.value))g.get(y).add(v.property);
            else r.trackUsedVariables(v.value);
            if (v.property === "animation") for (let y of er(v.value))f.add(y);
            if (i & 2 && v.value.includes("color-mix(")) {
                let y = H(v.value), S = !1;
                if (ee(y, (E, { replaceWith: P })=>{
                    if (E.kind !== "function" || E.value !== "color-mix") return;
                    let _ = !1, L = !1;
                    if (ee(E.nodes, (R, { replaceWith: G })=>{
                        ...
                        S = !0;
                        let B = r.theme.resolveValue(null, [
                            z.value
                        ]);
                        if (!B) {
                            _ = !0;
                        ...
                        let R = E.nodes.findIndex((z)=>z.kind === "separator" && z.value.trim().includes(","));
                        if (R === -1) return;
                        let G = E.nodes.length > R ? E.nodes[R + 1] : null;
                        if (!G) return;
                        P(G);
                    } else if (S) {
                        let R = E.nodes[2];
                    ...
                    let E = {
                        ...v,
                        value: J(y)
                    }, P = M("@supports (color: color-mix(in lab, red, red))", [
                        v
                    ]);
                    w.push(E, P);
                    return;
            ...
            w.push(v);
        } else if (v.kind === "rule") if (v.selector === "&") for (let y of v.nodes){
            let S = [];
            m(y, S, A, b1 + 1), S.length > 0 && w.push(...S);
        }
        else {
            let y = {
                ...v,
            ...
            for (let S of v.nodes)m(S, y.nodes, A, b1 + 1);
            y.nodes.length > 0 && w.push(y);
        }
        else if (v.kind === "at-rule" && v.name === "@property" && b1 === 0) {
            if (n.has(v.params)) return;
            if (i & 1) {
                let S = v.params, E = null, P = !1;
                for (let _ of v.nodes)_.kind === "declaration" && (_.property === "initial-value" ? E = _.value : _.property === "inherits" && (P = _.value === "true"));
                P ? u.push(l(S, E ?? "initial")) : c.push(l(S, E ?? "initial"));
            }
            n.add(v.params);
            let y = {
                ...v,
            ...
            for (let S of v.nodes)m(S, y.nodes, A, b1 + 1);
            v.name === "@keyframes" && A.theme && a.add(y), (y.nodes.length > 0 || y.name === "@layer" || y.name === "@charset" || y.name === "@custom-media" || y.name === "@namespace" || y.name === "@import") && w.push(y);
    ...
    let h = [];
    for (let v of t)m(v, h, {}, 0);
    e: for (let [v, w] of s)for (let A of w){
        if (tr(A.property, r.theme, g)) {
            if (A.property.startsWith(r.theme.prefixKey("--animate-"))) for (let S of er(A.value))f.add(S);
            continue;
        }
        let y = v.indexOf(A);
        if (v.splice(y, 1), v.length === 0) {
            let S = Vi(h, (E)=>E.kind === "rule" && E.nodes === v);
    ...
    for (let v of a)if (!f.has(v.params)) {
        let w = e.indexOf(v);
        e.splice(w, 1);
    }
    if (h = h.concat(e), i & 1) {
        let v = [];
        if (u.length > 0 && v.push(M(":root, :host", u)), c.length > 0 && v.push(M("*, ::before, ::after, ::backdrop", c)), v.length > 0) {
            let w = h.findIndex((A)=>!(A.kind === "comment" || A.kind === "at-rule" && (A.name === "@charset" || A.name === "@import")));
            h.splice(w < 0 ? h.length : w, 0, j("@layer", "properties", [])), h.push(M("@layer properties", [
                j("@supports", "((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b))))", v)
            ]));
        }
    }
    return h;
...
var bt = [
    ...
    "anchor-size"
], rr = new RegExp(`(${Ze.join("|")})\\(`, "g");
function Pe(t) {
    return t.indexOf("(") !== -1 && bt.some((r)=>t.includes(`${r}(`));
}
function ir(t) {
    if (!bt.some((n)=>t.includes(n))) return t;
    let r = !1;
    Ze.some((n)=>t.includes(n)) && (rr.lastIndex = 0, t = t.replace(rr, (n, s)=>(r = !0, `$${Ze.indexOf(s)}$(`)));
    let i = "", e = [];
    for(let n = 0; n < t.length; n++){
        let s = t[n];
        if (s === "(") {
    ...
    return r ? i.replace(/\$(\d+)\$/g, (n, s)=>Ze[s] ?? n) : i;
}
function ce(t) {
    if (t.indexOf("(") === -1) return Ce(t);
    let r = H(t);
    return xt(r), t = J(r), t = ir(t), t;
}
function Ce(t, r = !1) {
    let i = "";
    for(let e = 0; e < t.length; e++){
                ...
                if (r.value === "var" || r.value.endsWith("_var") || r.value === "theme" || r.value.endsWith("_theme")) {
                    ...
                    for(let i = 0; i < r.nodes.length; i++){
                        if (i == 0 && r.nodes[i].kind === "word") {
                            r.nodes[i].value = Ce(r.nodes[i].value, !0);
                            continue;
                        }
                        xt([
                            r.nodes[i]
...
function* ar(t, r) {
    ...
    let [a, f = null, u] = K(e, "/");
    if (u) return;
    let c = f === null ? null : Ct(f);
    if (f !== null && c === null) return;
    if (a[0] === "[") {
        if (a[a.length - 1] !== "]") return;
        let m = a.charCodeAt(1);
        if (m !== nr && !(m >= or && m <= lr)) return;
        a = a.slice(1, -1);
        let h = a.indexOf(":");
        if (h === -1 || h === 0 || h === a.length - 1) return;
        let v = a.slice(0, h), w = ce(a.slice(h + 1));
        if (!fe(w)) return;
        yield {
            kind: "arbitrary",
            property: v,
    ...
    if (a[a.length - 1] === "]") {
        ...
        let h = a.slice(0, m);
        if (!r.utilities.has(h, "functional")) return;
        let v = a.slice(m + 2, -1), w = K(v, ":"), A = null;
    ...
    } else g = ur(a, (m)=>r.utilities.has(m, "functional"));
    for (let [m, h] of g){
        let v = {
            kind: "functional",
            root: m,
        ...
        }
        {
            ...
            if (w !== -1) {
                ...
                let b1 = ce(h.slice(w + 1, -1));
                if (!fe(b1)) continue;
                let y = "";
                for(let S = 0; S < b1.length; S++){
                    let E = b1.charCodeAt(S);
                    if (E === Ti) {
                        y = b1.slice(0, S), b1 = b1.slice(S + 1);
                        break;
                    }
                    if (!(E === nr || E >= or && E <= lr)) break;
                }
                ...
                let b1 = f === null || v.modifier?.kind === "arbitrary" ? null : `${h}/${f}`;
                v.value = {
                    kind: "named",
                    value: h,
                    fraction: b1
...
function Ct(t) {
    ...
    if (t[0] === "(" && t[t.length - 1] === ")") {
        let r = ce(t.slice(1, -1));
        return !fe(r) || r.length === 0 || r.trim().length === 0 || r[0] !== "-" && r[1] !== "-" ? null : {
            kind: "arbitrary",
            value: `var(${r})`
        };
    }
...
function _i(t) {
    return K(t, " ").every((r)=>et(r) || pr(r) || r === "thin" || r === "medium" || r === "thick");
}
...
var le = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/, Li = new RegExp(`^${le.source}$`);
function pr(t) {
    return Li.test(t) || Pe(t);
}
var Mi = new RegExp(`^${le.source}%$`);
function Nt(t) {
    return Mi.test(t) || Pe(t);
}
var Wi = new RegExp(`^${le.source}s*/s*${le.source}$`);
function Bi(t) {
    return Wi.test(t) || Pe(t);
}
var qi = [
    "cm",
    "mm",
    ...
    "cqmin",
    "cqmax"
], Hi = new RegExp(`^${le.source}(${qi.join("|")})$`);
function et(t) {
    return Hi.test(t) || Pe(t);
}
function Gi(t) {
    let r = 0;
    for (let i of K(t, " ")){
...
var Ji = [
    ...
    "grad",
    "turn"
], Qi = new RegExp(`^${le.source}(${Ji.join("|")})$`);
function Zi(t) {
    return Qi.test(t);
}
var Xi = new RegExp(`^${le.source} +${le.source} +${le.source}$`);
function en(t) {
    return Xi.test(t);
}
function T(t) {
...
function _e(t, r) {
    return K(t, ",").map((e)=>{
        ...
        for (let c of n)tn.has(c) || (mr.test(c) ? (a === null ? a = c : f === null && (f = c), mr.lastIndex = 0) : s === null && (s = c));
        if (a === null || f === null) return e;
        let u = r(s ?? "currentcolor");
        return s !== null ? e.replace(s, u) : `${e} ${u}`;
    }).join(", ");
}
var rn = /^-?[a-z][a-zA-Z0-9/%._-]*$/, nn = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/, it = [
    "0",
    "0.5",
    "1",
    "1.5",
...
function Q(t, r, i) {
    ...
    return e ? Y(t, e) : tt(r.value) ? Y(t, `${r.value}%`) : null;
}
function Z(t, r, i) {
    let e = null;
...
function vr(t) {
    ...
    function i(o, p) {
        let d = /(\d+)_(\d+)/g;
        function* x(N) {
            for (let O of t.keysInNamespaces(N))yield O.replace(d, ($, V, U)=>`${V}.${U}`);
        }
        let k = [
            "1/2",
            "1/3",
        ...
        r.suggest(o, ()=>{
            ...
            for (let O of p()){
                ...
                let $ = [
                    ...
                    ...O.modifiers ?? [],
                    ...x(O.modifierThemeKeys ?? [])
                ];
                O.supportsFractions && $.push(...k), O.hasDefaultValue && $.unshift(null), N.push({
    ...
    function e(o, p) {
        r.static(o, ()=>p.map((d)=>typeof d == "function" ? d() : l(d[0], d[1])));
    }
    function n(o, p) {
        function d({ negative: x }) {
            return (k)=>{
                ...
                if (k.value) if (k.value.kind === "arbitrary") {
                    ...
                    N = k.value.value, O = k.value.dataType;
                } else {
                    if (N = t.resolve(k.value.fraction ?? k.value.value, p.themeKeys ?? []), N === null && p.supportsFractions && k.value.fraction) {
                        let [$, V] = K(k.value.fraction, "/");
                        if (!T($) || !T(V)) return;
                        N = `calc(${k.value.fraction} * 100%)`;
                    }
                    if (N === null && x && p.handleNegativeBareValue) {
                        if (N = p.handleNegativeBareValue(k.value), !N?.includes("/") && k.modifier) return;
                        if (N !== null) return p.handle(N, null);
                    }
                    if (N === null && p.handleBareValue && (N = p.handleBareValue(k.value), !N?.includes("/") && k.modifier)) return;
                }
                else {
                    if (k.modifier) return;
                    N = p.defaultValue !== void 0 ? p.defaultValue : t.resolve(null, p.themeKeys ?? []);
                }
                if (N !== null) return p.handle(x ? `calc(${N} * -1)` : N, O);
            };
        }
        p.supportsNegative && r.functional(`-${o}`, d({
            negative: !0
        })), r.functional(o, d({
            negative: !1
        })), i(o, ()=>[
    ...
    function s(o, p) {
        r.functional(o, (d)=>{
            if (!d.value) return;
            let x = null;
            if (d.value.kind === "arbitrary" ? (x = d.value.value, x = Q(x, d.modifier, t)) : x = Z(d, t, p.themeKeys), x !== null) return p.handle(x);
        }), i(o, ()=>[
                {
                    values: [
                        "current",
    ...
    function a(o, p, d, { supportsNegative: x = !1, supportsFractions: k = !1 } = {}) {
    ...
    r.static("container", ()=>{
        ...
        o.sort((d, x)=>we(d, x, "asc"));
        let p = [
            l("--tw-sort", "--tw-container-component"),
            l("width", "100%")
        ];
        for (let d of o)p.push(j("@media", `(width >= ${d})`, [
            l("max-width", d)
        ]));
        return p;
    }), e("flex-auto", [
        ...
        if (o.value) {
            ...
            if (o.value.fraction) {
                let [p, d] = K(o.value.fraction, "/");
                return !T(p) || !T(d) ? void 0 : [
    ...
    function g({ negative: o }) {
        return (p)=>{
            ...
            let d;
            return p.value.kind === "arbitrary" ? (d = p.value.value, [
                l("scale", d)
            ]) : (d = t.resolve(p.value.value, [
                "--scale"
            ]), !d && T(p.value.value) && (d = `${p.value.value}%`), d ? (d = o ? `calc(${d} * -1)` : d, [
                c(),
                l("--tw-scale-x", d),
                l("--tw-scale-y", d),
                l("--tw-scale-z", d),
    ...
    function m({ negative: o }) {
        return (p)=>{
            ...
            } else if (d = t.resolve(p.value.value, [
                "--rotate"
            ]), !d && T(p.value.value) && (d = `${p.value.value}deg`), !d) return;
            return [
        ...
        ]);
    {
        ...
        n("skew", {
            ...
            handleBareValue: ({ value: d })=>T(d) ? `${d}deg` : null,
            handle: (d)=>[
                    p(),
                    l("--tw-skew-x", `skewX(${d})`),
                    l("--tw-skew-y", `skewY(${d})`),
    ...
    e("grid-flow-row", [
        ...
        handleBareValue: ({ value: o })=>$t(o) ? `repeat(${o}, minmax(0, 1fr))` : null,
        handle: (o)=>[
        ...
        let d = function(N) {
            ...
            return (O)=>{
                ...
                return [
                    ...
                    M("@supports (background-image: linear-gradient(in lab, red, red))", [
            ...
            return (O)=>{
                ...
                let V = O.value.value;
                if (T(V)) return V = N ? `calc(${V}deg * -1)` : `${V}deg`, [
                    l("--tw-gradient-position", `from ${V} ${$}`),
                    l("background-image", "conic-gradient(var(--tw-gradient-stops))")
                ];
            };
        };
        ...
        if (o.value) {
            if (o.value.kind === "arbitrary") {
                ...
                switch(o.value.dataType ?? W(p, [
                    ...
                    default:
                        return p = Q(p, o.modifier, t), p === null ? void 0 : [
            ...
            if (d.value) {
                if (d.value.kind === "arbitrary") {
                    ...
                    switch(d.value.dataType ?? W(x, [
                        ...
                        case "length":
                        case "percentage":
                            return d.modifier ? void 0 : p.position(x);
                        default:
                            return x = Q(x, d.modifier, t), x === null ? void 0 : p.color(x);
                    }
                }
                {
                    let x = Z(d, t, [
                ...
                }
                {
                    ...
                    if (x) return p.position(x);
                    if (d.value.value[d.value.value.length - 1] === "%" && T(d.value.value.slice(0, -1))) return p.position(d.value.value);
                }
            }
        }), i(o, ()=>[
                {
                ...
                if (d.value.kind === "arbitrary") {
                    ...
                    switch(d.value.dataType ?? W(x, [
                        ...
                        case "color":
                            return x = Q(x, d.modifier, t), x === null ? void 0 : p.color(x);
                        case "percentage":
                            return d.modifier || !T(x.slice(0, -1)) ? void 0 : p.position(x);
                        default:
                            return d.modifier ? void 0 : p.position(x);
                    }
                }
                        ...
                        case "number":
                            {
                                ...
                                return !k || !ke(d.value.value) ? void 0 : p.position(`calc(${k} * ${d.value.value})`);
                            }
                        case "percentage":
                            return T(d.value.value.slice(0, -1)) ? p.position(d.value.value) : void 0;
                        default:
                            return;
                    }
                }
        ...
        y(o, {
            ...
            position (x) {
                ...
                for (let N of [
                    ...
                    C(`--tw-mask-${N}-from-color`, "black"),
                    C(`--tw-mask-${N}-to-color`, "transparent")
                ])), k.push(l(`--tw-mask-${N}-${p}-position`, x)));
                return k;
            }
        });
    }
        ...
        if (o.value) {
            if (o.value.kind === "arbitrary") {
                ...
                switch(o.value.dataType ?? W(p, [
                    ...
                    default:
                        return p = Q(o.value.value, o.modifier, t), p === null ? void 0 : [
                            l("stroke", p)
                        ];
                }
            }
    ...
    });
    {
        ...
        r.functional("filter", (k)=>{
            ...
            let N;
            if (k.modifier && (k.modifier.kind === "arbitrary" ? N = k.modifier.value : T(k.modifier.value) && (N = `${k.modifier.value}%`)), !k.value) {
                let O = t.get([
                    "--drop-shadow"
                ]), $ = t.resolve(null, [
                    "--drop-shadow"
                ...
                return O === null || $ === null ? void 0 : [
                    ...
                    ...rt("--tw-drop-shadow-size", O, N, (V)=>`var(--tw-drop-shadow-color, ${V})`),
                    l("--tw-drop-shadow", K($, ",").map((V)=>`drop-shadow(${V})`).join(" ")),
                    l("filter", o)
                ];
            }
            if (k.value.kind === "arbitrary") {
                let O = k.value.value;
                switch(k.value.dataType ?? W(O, [
                    "color"
                ])){
                    case "color":
                        return O = Q(O, k.modifier, t), O === null ? void 0 : [
                            d(),
                            l("--tw-drop-shadow-color", Y(O, "var(--tw-drop-shadow-alpha)")),
            ...
            }
            {
                ...
                if (O && $) return k.modifier && !N ? void 0 : N ? [
                    d(),
                    l("--tw-drop-shadow-alpha", N),
                    ...rt("--tw-drop-shadow-size", O, N, (V)=>`var(--tw-drop-shadow-color, ${V})`),
                    l("--tw-drop-shadow", "var(--tw-drop-shadow-size)"),
            ...
            handleBareValue: ({ value: k })=>tt(k) ? `${k}%` : null,
            handle: (k)=>[
                    x(),
    ...
    }
    {
        ...
        e("transition-none", [
            ...
            handleBareValue: ({ value: d })=>T(d) ? `${d}ms` : null,
            themeKeys: [
                "--transition-delay"
            ],
            handle: (d)=>[
        ...
        });
        {
            ...
            e("duration-initial", [
                ...
                if (x.value.kind === "arbitrary" ? k = x.value.value : (k = t.resolve(x.value.fraction ?? x.value.value, [
                    "--transition-duration"
                ]), k === null && T(x.value.value) && (k = `${x.value.value}ms`)), k !== null) return [
                    d(),
                    l("--tw-duration", k),
    ...
    {
        let o = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)", p = ()=>D([
                C("--tw-contain-size"),
                C("--tw-contain-layout"),
                C("--tw-contain-paint"),
                C("--tw-contain-style")
    ...
    {
        let o = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)", p = ()=>D([
                C("--tw-ordinal"),
                C("--tw-slashed-zero"),
                C("--tw-numeric-figure"),
        ...
        r.static("outline-hidden", ()=>[
            ...
            if (p.value.kind === "arbitrary") {
                ...
                switch(p.value.dataType ?? W(d, [
                    ...
                    default:
                        return d = Q(d, p.modifier, t), d === null ? void 0 : [
                            l("outline-color", d)
                        ];
                }
            }
    ...
    n("opacity", {
        ...
        handleBareValue: ({ value: o })=>tt(o) ? `${o}%` : null,
        handle: (o)=>[
                l("opacity", o)
            ]
    }), i("opacity", ()=>[
    ...
    e("text-shadow-initial", [
        ...
        if (o.modifier && (o.modifier.kind === "arbitrary" ? p = o.modifier.value : T(o.modifier.value) && (p = `${o.modifier.value}%`)), !o.value) {
            ...
            return d === null ? void 0 : [
                ...
                ...ae("text-shadow", d, p, (x)=>`var(--tw-text-shadow-color, ${x})`)
            ];
        }
        if (o.value.kind === "arbitrary") {
            let d = o.value.value;
            switch(o.value.dataType ?? W(d, [
                "color"
            ])){
                case "color":
                    return d = Q(d, o.modifier, t), d === null ? void 0 : [
                        R(),
                        l("--tw-text-shadow-color", Y(d, "var(--tw-text-shadow-alpha)"))
                    ];
                default:
                    return [
                        R(),
                        l("--tw-text-shadow-alpha", p),
                        ...ae("text-shadow", d, p, (k)=>`var(--tw-text-shadow-color, ${k})`)
                    ];
            }
        }
        ...
        ]);
    {
        ...
        e("shadow-initial", [
            ...
            if ($.modifier && ($.modifier.kind === "arbitrary" ? V = $.modifier.value : T($.modifier.value) && (V = `${$.modifier.value}%`)), !$.value) {
                ...
                return U === null ? void 0 : [
                    d(),
                    l("--tw-shadow-alpha", V),
                    ...ae("--tw-shadow", U, V, (ie)=>`var(--tw-shadow-color, ${ie})`),
                    l("box-shadow", o)
                ];
            }
            if ($.value.kind === "arbitrary") {
                let U = $.value.value;
                switch($.value.dataType ?? W(U, [
                    "color"
                ])){
                    case "color":
                        return U = Q(U, $.modifier, t), U === null ? void 0 : [
                            d(),
                            l("--tw-shadow-color", Y(U, "var(--tw-shadow-alpha)"))
                        ];
                    default:
                        return [
                            d(),
                            l("--tw-shadow-alpha", V),
                            ...ae("--tw-shadow", U, V, (mt)=>`var(--tw-shadow-color, ${mt})`),
                            l("box-shadow", o)
                        ];
                }
            }
            ...
            if ($.modifier && ($.modifier.kind === "arbitrary" ? V = $.modifier.value : T($.modifier.value) && (V = `${$.modifier.value}%`)), !$.value) {
                ...
                return U === null ? void 0 : [
                    ...
                    ...ae("--tw-inset-shadow", U, V, (ie)=>`var(--tw-inset-shadow-color, ${ie})`),
                    l("box-shadow", o)
                ];
            }
            if ($.value.kind === "arbitrary") {
                ...
                switch($.value.dataType ?? W(U, [
                    ...
                    case "color":
                        return U = Q(U, $.modifier, t), U === null ? void 0 : [
                            d(),
                            l("--tw-inset-shadow-color", Y(U, "var(--tw-inset-shadow-alpha)"))
                        ];
                    default:
                        return [
                            d(),
                            l("--tw-inset-shadow-alpha", V),
                            ...ae("--tw-inset-shadow", U, V, (mt)=>`var(--tw-inset-shadow-color, ${mt})`, "inset "),
                            l("box-shadow", o)
                        ];
                }
            }
        ...
        r.functional("ring", ($)=>{
            if (!$.value) {
                ...
                return [
                    d(),
                    l("--tw-ring-shadow", k(V)),
                    l("box-shadow", o)
                ];
            }
            if ($.value.kind === "arbitrary") {
                let V = $.value.value;
                switch($.value.dataType ?? W(V, [
                    "color",
                    "length"
                ])){
                    case "length":
                    ...
                    default:
                        return V = Q(V, $.modifier, t), V === null ? void 0 : [
                            l("--tw-ring-color", V)
                        ];
                }
            }
            ...
            {
                if ($.modifier) return;
                let V = t.resolve($.value.value, [
                    "--ring-width"
                ]);
                if (V === null && T($.value.value) && (V = `${$.value.value}px`), V) return [
                    d(),
                    l("--tw-ring-shadow", k(V)),
                    l("box-shadow", o)
                ];
    ...
    return nn.test(r) ? (i)=>{
        ...
        I(t.nodes, (n)=>{
            ...
            ee(s, (a)=>{
                ...
                } else if (u.kind === "word" && !(u.value[0] === "[" && u.value[u.value.length - 1] === "]") && !St.includes(u.value)) {
                    console.warn(`Unsupported bare value data type: "${u.value}".
Only valid data types are: ${St.map((A)=>`"${A}"`).join(", ")}.
`);
                    let c = u.value, g = structuredClone(a), m = "\xB6";
                    ee(g.nodes, (A, { replaceWith: b1 })=>{
...
`);
            ...
            if (a === null) return;
            let u = !1, c = !1, g = !1, m = !1, h = new Map, v = !1;
            if (I([
                s
            ], (w, { parent: A, replaceWith: b1 })=>{
                if (A?.kind !== "rule" && A?.kind !== "at-rule" || w.kind !== "declaration" || !w.value) return;
                let y = H(w.value);
                (ee(y, (E, { replaceWith: P })=>{
                    if (E.kind === "function") {
                        if (E.value === "--value") {
                            u = !0;
                            let _ = gr(a, E, i);
                            return _ ? (c = !0, _.ratio ? v = !0 : h.set(w, A), P(_.nodes), 1) : (u ||= !1, b1([]), 2);
                        } else if (E.value === "--modifier") {
                            if (f === null) return b1([]), 2;
                            g = !0;
                            let _ = gr(f, E, i);
                            return _ ? (m = !0, P(_.nodes), 1) : (g ||= !1, b1([]), 2);
                        }
                    }
                }) ?? 0) === 0 && (w.value = J(y));
            }), u && !c || g && !m || v && m || f && !v && !m) return null;
            ...
            let n = [], s = [];
            for (let [a, { literals: f, usedSpacingNumber: u, usedSpacingInteger: c, themeKeys: g }] of [
                [
                    n,
                    e["--value"]
                ],
                ...
                if (u) a.push(...it);
                else if (c) for (let m of it)T(m) && a.push(m);
                for (let m of i.theme.keysInNamespaces(g))a.push(m);
            }
            return [
                {
                    values: n,
...
function gr(t, r, i) {
    for (let e of r.nodes){
        ...
        if (t.kind === "named" && e.kind === "word" && e.value[0] === "-" && e.value[1] === "-") {
            ...
            if (!St.includes(e.value)) continue;
...
function ae(t, r, i, e, n = "") {
    let s = !1, a = _e(r, (u)=>i == null ? e(u) : u.startsWith("current") ? e(Y(u, i)) : ((u.startsWith("var(") || i.startsWith("var(")) && (s = !0), e(hr(u, i))));
    function f(u) {
        return n ? K(u, ",").map((c)=>n + c).join(",") : u;
    }
    return s ? [
        l(t, f(_e(r, e))),
        M("@supports (color: lab(from red l a b))", [
            l(t, f(a))
        ])
    ] : [
        l(t, f(a))
...
function rt(t, r, i, e, n = "") {
    let s = !1, a = K(r, ",").map((f)=>_e(f, (u)=>i == null ? e(u) : u.startsWith("current") ? e(Y(u, i)) : ((u.startsWith("var(") || i.startsWith("var(")) && (s = !0), e(hr(u, i))))).map((f)=>`drop-shadow(${f})`).join(" ");
    return s ? [
        l(t, n + K(r, ",").map((f)=>`drop-shadow(${_e(f, e)})`).join(" ")),
        M("@supports (color: lab(from red l a b))", [
            l(t, n + a)
        ])
    ] : [
...
var kr = new RegExp(Object.keys(Tt).map((t)=>`${t}\\(`).join("|"));
function Ne(t, r) {
    let i = 0;
    return I(t, (e)=>{
        ...
        e.kind === "at-rule" && (e.name === "@media" || e.name === "@custom-media" || e.name === "@container" || e.name === "@supports") && kr.test(e.params) && (i |= 8, e.params = yr(e.params, e, r));
    }), i;
}
function yr(t, r, i) {
    let e = H(t);
    return ee(e, (n, { replaceWith: s })=>{
        if (n.kind === "function" && n.value in Tt) {
            let a = K(J(n.nodes).trim(), ",").map((u)=>u.trim()), f = Tt[n.value](i, r, ...a);
            return s(H(f));
        }
    }), J(e);
}
...
function br(t) {
    ...
    for (let e of t.utilities.keys("functional")){
        ...
        for (let s of n)for (let a of s.values){
            let f = a !== null && fn.test(a), u = a === null ? e : `${e}-${a}`;
            r.push({
                name: u,
                utility: e,
                fraction: f,
    ...
    return r.length === 0 ? [] : (r.sort((e, n)=>nt(e.name, n.name)), pn(r));
}
function pn(t) {
    let r = [], i = null, e = new Map, n = new q(()=>[]);
    for (let a of t){
...
function xr(t) {
    ...
    for (let [e, n] of t.variants.entries()){
        let f = function({ value: u, modifier: c } = {}) {
            ...
            if (Ve(h, m, t.variants) === null) return [];
            let v = [];
            return Ye(h.nodes, (w, { path: A })=>{
                if (w.kind !== "rule" && w.kind !== "at-rule" || w.nodes.length > 0) return;
                A.sort((S, E)=>{
                    let P = S.kind === "at-rule", _ = E.kind === "at-rule";
                    return P && !_ ? -1 : !P && _ ? 1 : 0;
                });
                let b1 = A.flatMap((S)=>S.kind === "rule" ? S.selector === "&" ? [] : [
                        S.selector
                    ] : S.kind === "at-rule" ? [
                        `${S.name} ${S.params}`
                    ] : []), y = "";
                for(let S = b1.length - 1; S >= 0; S--)y = y === "" ? b1[S] : `${b1[S]} { ${y} }`;
                v.push(y);
            }), v;
        };
        var i = f;
...
function Ar(t, r) {
    let { astNodes: i, nodeSorting: e } = pe(Array.from(r), t), n = new Map(r.map((a)=>[
            a,
            null
        ])), s = 0n;
    for (let a of i){
...
function Nr(t) {
    let r = new Et;
    function i(c, g, { compounds: m } = {}) {
        m = m ?? ye(g), r.static(c, (h)=>{
            h.nodes = g.map((v)=>M(v, h.nodes));
        }, {
            compounds: m
        });
    }
    ...
    function s(c) {
        for (let g of n){
            ...
            let m = K(c.params, ",");
            return m.length > 1 ? null : (m = e(c.name, m), j(c.name, m.join(", ")));
        }
        return null;
    }
    function a(c) {
    ...
    r.compound("not", 3, (c, g)=>{
        ...
        if (I([
            ...
            let w = [], A = [];
            for (let y of v)y.kind === "at-rule" ? w.push(y) : y.kind === "rule" && A.push(y);
            ...
            return Object.assign(c, F("&", b1)), m = !0, 1;
        ...
        let m = g.modifier ? `:where(.${t.prefix ? `${t.prefix}\\:` : ""}group\\/${g.modifier.value})` : `:where(.${t.prefix ? `${t.prefix}\\:` : ""}group)`, h = !1;
        if (I([
            c
        ], (v, { path: w })=>{
            ...
            K(A, ",").length > 1 && (A = `:is(${A})`), v.selector = `&:is(${A} *)`, h = !0;
        }), !h) return null;
    }), r.suggest("group", ()=>Array.from(r.keys()).filter((c)=>r.compoundsWith("group", c))), r.compound("peer", 2, (c, g)=>{
        if (g.variant.kind === "arbitrary" && g.variant.relative) return null;
        let m = g.modifier ? `:where(.${t.prefix ? `${t.prefix}\\:` : ""}peer\\/${g.modifier.value})` : `:where(.${t.prefix ? `${t.prefix}\\:` : ""}peer)`, h = !1;
        if (I([
            c
        ], (v, { path: w })=>{
            if (v.kind !== "rule") return 0;
    ...
    i("first", [
        ...
        g.value.kind === "arbitrary" ? c.nodes = [
            F(`&[aria-${Cr(g.value.value)}]`, c.nodes)
        ] : c.nodes = [
            F(`&[aria-${g.value.value}="true"]`, c.nodes)
        ];
    }), r.suggest("aria", ()=>[
            "busy",
            "checked",
        ...
        if (!g.value || g.modifier) return null;
        c.nodes = [
            F(`&[data-${Cr(g.value.value)}]`, c.nodes)
        ];
    }), r.functional("nth", (c, g)=>{
        if (!g.value || g.modifier || g.value.kind === "named" && !T(g.value.value)) return null;
        c.nodes = [
            F(`&:nth-child(${g.value.value})`, c.nodes)
        ];
    }), r.functional("nth-last", (c, g)=>{
        if (!g.value || g.modifier || g.value.kind === "named" && !T(g.value.value)) return null;
        c.nodes = [
            F(`&:nth-last-child(${g.value.value})`, c.nodes)
        ];
    }), r.functional("nth-of-type", (c, g)=>{
        if (!g.value || g.modifier || g.value.kind === "named" && !T(g.value.value)) return null;
        c.nodes = [
            F(`&:nth-of-type(${g.value.value})`, c.nodes)
        ];
    }), r.functional("nth-last-of-type", (c, g)=>{
        if (!g.value || g.modifier || g.value.kind === "named" && !T(g.value.value)) return null;
        c.nodes = [
            F(`&:nth-last-of-type(${g.value.value})`, c.nodes)
        ];
    ...
    {
        let c = function(g, m, h, v) {
            if (g === m) return 0;
            let w = v.get(g);
            if (w === null) return h === "asc" ? -1 : 1;
            let A = v.get(m);
            return A === null ? h === "asc" ? 1 : -1 : we(w, A, h);
        };
        var u = c;
        {
            let g = t.namespace("--breakpoint"), m = new q((h)=>{
                switch(h.kind){
                    case "static":
                    ...
                    case "functional":
                        {
                            ...
                            let v = null;
                            return h.value.kind === "arbitrary" ? v = h.value.value : h.value.kind === "named" && (v = t.resolveValue(h.value.value, [
                                "--breakpoint"
            ...
            r.group(()=>{
                r.functional("max", (h, v)=>{
                    if (v.modifier) return null;
                    let w = m.get(v);
                    if (w === null) return null;
                    h.nodes = [
                        j("@media", `(width < ${w})`, h.nodes)
                    ];
                }, {
                    compounds: 1
                });
            }, (h, v)=>c(h, v, "desc", m)), r.suggest("max", ()=>Array.from(g.keys()).filter((h)=>h !== null)), r.group(()=>{
                for (let [h, v] of t.namespace("--breakpoint"))h !== null && r.static(h, (w)=>{
                    w.nodes = [
                        j("@media", `(width >= ${v})`, w.nodes)
                    ];
                }, {
                    compounds: 1
                });
                r.functional("min", (h, v)=>{
                    if (v.modifier) return null;
                    let w = m.get(v);
                    if (w === null) return null;
                    h.nodes = [
            ...
            }, (h, v)=>c(h, v, "asc", m)), r.suggest("min", ()=>Array.from(g.keys()).filter((h)=>h !== null));
        }
        {
            let g = t.namespace("--container"), m = new q((h)=>{
                switch(h.kind){
                    case "functional":
                        {
            ...
            r.group(()=>{
                r.functional("@max", (h, v)=>{
                    ...
                    if (w === null) return null;
                    h.nodes = [
                        j("@container", v.modifier ? `${v.modifier.value} (width < ${w})` : `(width < ${w})`, h.nodes)
                    ];
                }, {
                    compounds: 1
                });
            ...
            }, (h, v)=>c(h, v, "asc", m)), r.suggest("@min", ()=>Array.from(g.keys()).filter((h)=>h !== null)), r.suggest("@", ()=>Array.from(g.keys()).filter((h)=>h !== null));
        }
    }
    return i("portrait", [
...
function Rt(t, r) {
    I(t, (i, { replaceWith: e })=>{
        if (i.kind === "at-rule" && i.name === "@slot") e(r);
            ...
            j(i.name, i.params, i.nodes)
        ])), 1;
    });
}
function $r(t) {
    let r = vr(t), i = Nr(t), e = new q((u)=>sr(u, f)), n = new q((u)=>Array.from(ar(u, f))), s = new q((u)=>{
        let c = Vr(u, f);
        try {
            Ne(c.map(({ node: g })=>g), f);
        } catch  {
        ...
        candidatesToCss (u) {
            ...
            for (let g of u){
                ...
                h = ve(h, f, 0), h.length === 0 || m ? c.push(null) : c.push(te(h));
            }
            return c;
        },
        getClassOrder (u) {
...
function pe(t, r, { onInvalidCandidate: i } = {}) {
        ...
        for (let g of u){
            ...
            if (m.length !== 0) {
                ...
                for (let { node: h, propertySort: v } of m){
                    let w = 0n;
                    for (let A of g.variants)w |= 1n << BigInt(a.get(A));
                    e.set(h, {
                        properties: v,
                        variants: w,
                        candidate: f
    ...
    return n.sort((f, u)=>{
        ...
        return (c.properties.order[m] ?? 1 / 0) - (g.properties.order[m] ?? 1 / 0) || g.properties.count - c.properties.count || nt(c.candidate, g.candidate);
    }), {
        astNodes: n,
        nodeSorting: e
    };
...
function Vr(t, r) {
    ...
    for (let s of i){
        ...
        for (let u of t.variants)if (Ve(f, u, r.variants) === null) return [];
        e.push({
            node: f,
            propertySort: a
        });
...
function Ve(t, r, i, e = 0) {
    ...
    if (r.kind === "compound") {
        let a = j("@slot");
        if (Ve(a, r.variant, i, e + 1) === null || r.root === "not" && a.nodes.length > 1) return null;
    ...
    for(; e.length > 0;){
        ...
        if (s.kind === "declaration") {
            ...
            if (s.property === "--tw-sort") {
                let f = Ot.indexOf(s.value ?? "");
                if (f !== -1) {
                    r.add(f), n = !0;
                    continue;
                }
            }
            let a = Ot.indexOf(s.property);
            a !== -1 && r.add(a);
...
function Ue(t, r) {
    let i = 0, e = M("&", t), n = new Set, s = new q(()=>new Set), a = new q(()=>new Set);
    I([
        e
    ], (m, { parent: h })=>{
        if (m.kind === "at-rule") {
            ...
            if (m.name === "@utility") {
                ...
                a.get(v).add(m), I(m.nodes, (w)=>{
                    if (!(w.kind !== "at-rule" || w.name !== "@apply")) {
                        n.add(m);
                        for (let A of Er(w, r))s.get(m).add(A);
                    }
                });
                return;
            }
            if (m.name === "@apply") {
                if (h === null) return;
                i |= 1, n.add(h);
                for (let v of Er(m, r))s.get(h).add(v);
            }
        }
    });
            ...
            if (c.has(m)) {
                ...
                throw m.kind === "at-rule" && m.name === "@utility" && v.kind === "at-rule" && v.name === "@utility" && I(m.nodes, (w)=>{
                    ...
                    for (let b1 of A)for (let y of r.parseCandidate(b1))switch(y.kind){
                        ...
                        case "static":
                        case "functional":
                            if (v.params.replace(/-\*$/, "") === y.root) throw new Error(`You cannot \`@apply\` the \`${b1}\` utility here because it creates a circular dependency.`);
                            break;
                        default:
                    }
...
${te([
            ...
            c.add(m);
            for (let v of s.get(m))for (let w of a.get(v))h.push(m), g(w, h), h.pop();
    ...
    for (let m of u)if ("nodes" in m) for(let h = 0; h < m.nodes.length; h++){
        ...
        let w = v.params.split(/\s+/g);
        {
            ...
            for (let y of A)if (y.kind === "rule") for (let S of y.nodes)b1.push(S);
            else b1.push(y);
...
async function Pt(t, r, i, e = 0) {
    let n = 0, s = [];
    return I(t, (a, { replaceWith: f })=>{
        if (a.kind === "at-rule" && (a.name === "@import" || a.name === "@reference")) {
            ...
            return s.push((async ()=>{
                ...
                let w = await i(c, r), A = ge(w.content);
                await Pt(A, w.base, i, e + 1), v.nodes = hn([
                    ne({
                        base: w.base
                    }, A)
                ], g, m, h);
...
function hn(t, r, i, e) {
    ...
    return r !== null && (n = [
        ...
        j("@supports", e[0] === "(" ? e : `(${e})`, n)
    ]), n;
}
function Se(t, r = null) {
...
function Rr(t, { theme: r }, i) {
    ...
    if (Object.hasOwn(r, "fontFamily")) {
        let e = 5;
        {
            let n = Se(r.fontFamily.sans);
            n && t.theme.hasDefault("--font-sans") && (t.theme.add("--default-font-family", n, e), t.theme.add("--default-font-feature-settings", Se(r.fontFamily.sans, "fontFeatureSettings") ?? "normal", e), t.theme.add("--default-font-variation-settings", Se(r.fontFamily.sans, "fontVariationSettings") ?? "normal", e));
        }
        {
            let n = Se(r.fontFamily.mono);
            n && t.theme.hasDefault("--font-mono") && (t.theme.add("--default-mono-font-family", n, e), t.theme.add("--default-mono-font-feature-settings", Se(r.fontFamily.mono, "fontFeatureSettings") ?? "normal", e), t.theme.add("--default-mono-font-variation-settings", Se(r.fontFamily.mono, "fontVariationSettings") ?? "normal", e));
        }
    }
    return r;
}
function vn(t) {
    ...
    return Or(t, [], (i, e)=>{
        ...
        if (Array.isArray(i) && i.every((n)=>typeof n == "string")) return r.push([
            e,
            i.join(", ")
        ]), 1;
    }), r;
...
function De(t, r, i, e = []) {
    for (let n of r)if (n != null) for (let s of Reflect.ownKeys(n)){
        e.push(s);
        let a = i(t[s], n[s], e);
        a !== void 0 ? t[s] = a : !Te(t[s]) || !Te(n[s]) ? t[s] = n[s] : t[s] = De({}, [
            t[s],
            n[s]
        ], i, e), e.pop();
    }
...
function st(t, r, i) {
    return function(n, s) {
        ...
        let u = (()=>{
            let c = at(n), [g, m] = bn(t.theme, c), h = i(Pr(r() ?? {}, c) ?? null);
            ...
            if (h !== null && typeof h == "object" && !Array.isArray(h)) {
                ...
                for(let w in g)w !== "__CSS_VALUES__" && (h?.__CSS_VALUES__?.[w] & 4 && Pr(v, w.split("-")) !== void 0 || (v[he(w)] = g[w]));
                return v;
            }
        ...
        return f && typeof u == "string" && (u = Y(u, f)), u ?? s;
    };
}
function bn(t, r) {
    ...
    let i = lt(r), e = new Map, n = new q(()=>new Map), s = t.namespace(`--${i}`);
    if (s.size === 0) return [
        null,
        0
    ];
    ...
    for (let [g, m] of s){
        if (!g || !g.includes("--")) {
            e.set(g, m), a.set(g, t.getOptions(g ? `--${i}-${g}` : `--${i}`));
            continue;
        }
        let h = g.indexOf("--"), v = g.slice(0, h), w = g.slice(h + 2);
        w = w.replace(/-([a-z])/g, (A, b1)=>b1.toUpperCase()), n.get(v === "" ? null : v).set(w, [
            m,
            t.getOptions(`--${i}${g}`)
        ]);
    }
    ...
    for (let [g, m] of n){
        ...
        let v = {}, w = {};
        for (let [A, [b1, y]] of m)v[A] = b1, w[A] = y;
        e.set(g, [
            h,
            v
        ]), a.set(g, [
    ...
    let u = {}, c = {};
    for (let [g, m] of e)_r(u, [
        g ?? "DEFAULT"
    ], m);
    for (let [g, m] of a)_r(c, [
        g ?? "DEFAULT"
    ], m);
...
function Ie(t, r, i = null) {
    for(let e = 0; e < t.length; e++){
        ...
        if (f === 2) return 2;
        if (f !== 1 && n.kind === "function" && Ie(n.nodes, r, n) === 2) return 2;
    }
}
function Fe(t) {
    let r = "";
...
var Kr = 92, $n = 93, Ur = 41, Vn = 58, Dr = 44, Sn = 34, Tn = 46, jr = 62, Ir = 10, En = 35, Fr = 91, zr = 40, Lr = 43, Rn = 39, Mr = 32, Wr = 9, Br = 126;
function ut(t) {
    t = t.replaceAll(`\r
`, `
`);
            ...
            case Br:
                {
                    ...
                    a = c - 1;
                    let g = t.slice(u, c), m = g.trim() === "," ? Cn(g) : xn(g);
            ...
            case zr:
                {
                    ...
                    if (n = "", u.value !== ":not" && u.value !== ":where" && u.value !== ":has" && u.value !== ":is") {
                        ...
                        let m = a;
                        u.nodes.push(Nn(t.slice(c, m))), n = "", a = m, e ? e.nodes.push(u) : r.push(u);
                        break;
                    }
    ...
    return n.length > 0 && r.push(je(n)), r;
}
var qr = /^[a-z@][a-zA-Z0-9/%._-]*$/;
function _t({ designSystem: t, ast: r, resolvedConfig: i, featuresRef: e, referenceMode: n }) {
    let s = {
        addBase (a) {
            if (n) return;
            let f = oe(a);
            e.current |= Ne(f, t), r.push(j("@layer", "base", f));
        },
        addVariant (a, f) {
            if (!ot.test(a)) throw new Error(`\`addVariant('${a}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
            typeof f == "string" || Array.isArray(f) ? t.variants.static(a, (u)=>{
                u.nodes = Hr(f, u.nodes);
            }, {
                compounds: ye(typeof f == "string" ? [
                    f
                ] : f)
            }) : typeof f == "object" && t.variants.fromAst(a, oe(f));
        },
        matchVariant (a, f, u) {
            function c(m, h, v) {
                let w = f(m, {
            ...
            t.variants.group(()=>{
                t.variants.functional(a, (m, h)=>{
                    ...
                    if (h.value.kind === "arbitrary") m.nodes = c(h.value.value, h.modifier, m.nodes);
                        ...
                        m.nodes = c(v, h.modifier, m.nodes);
                    }
                });
            }, (m, h)=>{
                ...
                let y = g.indexOf(v), S = g.indexOf(w);
                return y = y === -1 ? g.length : y, S = S === -1 ? g.length : S, y !== S ? y - S : A < b1 ? -1 : 1;
            });
        },
        addUtilities (a) {
            a = Array.isArray(a) ? a : [
            ...
            for (let [c, g] of f){
                ...
                let m = ut(c), h = !1;
                if (Ie(m, (v)=>{
                    if (v.kind === "selector" && v.value[0] === "." && qr.test(v.value.slice(1))) {
                        let w = v.value;
                        v.value = "&";
                        let A = Fe(m), b1 = w.slice(1), y = A === "&" ? oe(g) : [
                            M(A, oe(g))
                        ];
                        u.get(b1).push(...y), h = !0, v.value = w;
                        return;
                    }
            ...
            for (let [c, g] of u)t.theme.prefix && I(g, (m)=>{
                if (m.kind === "rule") {
                    let h = ut(m.selector);
                    Ie(h, (v)=>{
                ...
                return Gr(h, c, m.raw), e.current |= Ue(h, t), h;
            });
        },
        matchUtilities (a, f) {
            ...
            for (let [g, m] of Object.entries(a)){
                let h = function({ negative: v }) {
                    return (w)=>{
                        if (w.value?.kind === "arbitrary" && u.length > 0 && !u.includes("any") && (w.value.dataType && !u.includes(w.value.dataType) || !w.value.dataType && !W(w.value.value, u))) return;
                        let A = u.includes("color"), b1 = null, y = !1;
                        {
                            ...
                            }, P)), w.value ? w.value.kind === "arbitrary" ? b1 = w.value.value : w.value.fraction && P[w.value.fraction] ? (b1 = P[w.value.fraction], y = !0) : P[w.value.value] ? b1 = P[w.value.value] : P.__BARE_VALUE__ && (b1 = P.__BARE_VALUE__(w.value) ?? null, y = (w.value.fraction !== null && b1?.includes("/")) ?? !1) : b1 = P.DEFAULT ?? null;
                        }
                        if (b1 === null) return;
                        let S;
                        {
                            let P = f?.modifiers ?? null;
                            w.modifier ? P === "any" || w.modifier.kind === "arbitrary" ? S = w.modifier.value : P?.[w.modifier.value] ? S = P[w.modifier.value] : A && !Number.isNaN(Number(w.modifier.value)) ? S = `${w.modifier.value}%` : S = null : S = null;
                        }
                        if (w.modifier && S === null && !y) return w.value?.kind === "arbitrary" ? null : void 0;
                        A && S !== null && (b1 = Y(b1, S)), v && (b1 = `calc(${b1} * -1)`);
                        let E = oe(m(b1, {
                            modifier: S
                        }));
                        return Gr(E, g, w.raw), e.current |= Ue(E, t), E;
                    };
                };
                var c = h;
                if (!qr.test(g)) throw new Error(`\`matchUtilities({ '${g}' : \u2026 })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
                f?.supportsNegativeValues && t.utilities.functional(`-${g}`, h({
                    negative: !0
                }), {
                    types: u
                }), t.utilities.functional(g, h({
                    negative: !1
                }), {
                    types: u
                }), t.utilities.suggest(g, ()=>{
                    let v = f?.values ?? {}, w = new Set(Object.keys(v));
                    w.delete("__BARE_VALUE__"), w.has("DEFAULT") && (w.delete("DEFAULT"), w.add(null));
                    let A = f?.modifiers ?? {}, b1 = A === "any" ? [] : Object.keys(A);
                    return [
                        {
...
function oe(t) {
    ...
    for (let [e, n] of i)if (typeof n != "object") {
        ...
        r.push(l(e, String(n)));
    } else if (Array.isArray(n)) for (let s of n)typeof s == "string" ? r.push(l(e, s)) : r.push(M(e, oe(s)));
    else n !== null && r.push(M(e, oe(n)));
    return r;
}
function Hr(t, r) {
...
function Gr(t, r, i) {
    I(t, (e)=>{
        if (e.kind === "rule") {
            let n = ut(e.selector);
            Ie(n, (s)=>{
                s.kind === "selector" && s.value === `.${r}` && (s.value = `.${ue(i)}`);
            }), e.selector = Fe(n);
        }
    });
}
...
function Pn(t) {
    let r = [];
    if ("keyframes" in t.theme) for (let [i, e] of Object.entries(t.theme.keyframes))r.push(j("@keyframes", i, oe(e)));
    return r;
}
var ct = {
    inherit: "inherit",
...
function Un(t, r) {
    if (Array.isArray(t) && Te(t[0])) return t.concat(r);
    if (Array.isArray(r) && Te(r[0]) && Te(t)) return [
        t,
        ...r
    ];
    if (Array.isArray(r)) return r;
}
function Kt(t, { config: r, base: i, path: e, reference: n }) {
    let s = [];
    ...
    for (let u of r.presets ?? [])Kt(t, {
        path: e,
        base: i,
        config: u,
        reference: n
    });
    for (let u of s)t.plugins.push(u), u.config && Kt(t, {
        path: e,
        base: i,
        config: u.config,
...
function jn({ center: t, padding: r, screens: i }, e) {
    ...
    if (t && n.push(l("margin-inline", "auto")), (typeof r == "string" || typeof r == "object" && r !== null && "DEFAULT" in r) && n.push(l("padding-inline", typeof r == "string" ? r : r.DEFAULT)), typeof i == "object" && i !== null) {
        ...
        if (a.sort((f, u)=>we(f[1], u[1], "asc")), a.length > 0) {
            let [f] = a[0];
            n.push(j("@media", `(width >= --theme(--breakpoint-${f}))`, [
                l("max-width", "none")
            ]));
        }
...
\`@plugin\` options must be a flat list of declarations.`);
                    ...
                    let S = y.value, E = K(S, ",").map((P)=>{
                        if (P = P.trim(), P === "null") return null;
                        if (P === "true") return !0;
                        if (P === "false") return !1;
                        if (Number.isNaN(Number(P))) {
                            if (P[0] === '"' && P[P.length - 1] === '"' || P[0] === "'" && P[P.length - 1] === "'") return P.slice(1, -1);
                            if (P[0] === "{" && P[P.length - 1] === "}") throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${te([
                                y
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
                    ...
                    b1[y.property] = E.length === 1 ? E[0] : E;
                }
                a.push([
                    {
                        id: A,
    ...
    if (t.resolveThemeValue = function(h, v) {
        return h.startsWith("--") ? u(h, v) : (s |= oi({
            designSystem: t,
            base: r,
            ast: i,
            sources: n,
            configs: [],
            pluginDetails: []
        }), t.resolveThemeValue(h, v));
    }, !a.length && !f.length) return 0;
    let [c, g] = await Promise.all([
        Promise.all(f.map(async ({ id: m, base: h, reference: v })=>{
        ...
        Promise.all(a.map(async ([{ id: m, base: h, reference: v }, w])=>{
...
function oi({ designSystem: t, base: r, ast: i, sources: e, configs: n, pluginDetails: s }) {
    ...
    ]), { resolvedConfig: g, replacedThemeKeys: m } = Ut(t, u), h = t.resolveThemeValue;
    t.resolveThemeValue = function(y, S) {
        if (y[0] === "-" && y[1] === "-") return h(y, S);
        let E = w.theme(y, void 0);
    ...
    for (let { handler: b1, reference: y } of c.plugins)y ? (A ||= _t({
        ...v,
        referenceMode: !0
    }), b1(A)) : b1(w);
    if (Rr(t, g, m), Yr(t, g, m), ni(g, t), ii(g, t), ei(g, t), !t.theme.prefix && c.prefix) {
    ...
    if (!t.important && c.important === !0 && (t.important = !0), typeof c.important == "string") {
        let b1 = c.important;
        I(i, (y, { replaceWith: S, parent: E })=>{
            if (y.kind === "at-rule" && !(y.name !== "@tailwind" || y.params !== "utilities")) return E?.kind === "rule" && E.selector === b1 ? 2 : (S(F(b1, [
                y
            ])), 2);
        });
    }
...
function pt(t) {
    ...
    zn(f) ? c = Ln(f) : c = K(f, ","), c = c.flatMap((m)=>pt(m));
    let g = pt(u);
    for (let m of g)for (let h of c)i.push(e + h + m);
    return i;
}
function zn(t) {
    return ai.test(t);
...
function Ln(t) {
    ...
    if (/^-?\d+$/.test(i) && /^-?\d+$/.test(e)) {
        ...
        if (s > 0) for(let c = f; c <= u; c += s){
            let g = c.toString();
            a.push(g);
        }
        else for(let c = f; c >= u; c += s){
            let g = c.toString();
            a.push(g);
        }
    }
...
var Mn = /^[a-z]+$/, Qe = ((n)=>(n[n.None = 0] = "None", n[n.AtProperty = 1] = "AtProperty", n[n.ColorMix = 2] = "ColorMix", n[n.All = 3] = "All", n))(Qe || {});
function Wn() {
...
var $e = ((f)=>(f[f.None = 0] = "None", f[f.AtApply = 1] = "AtApply", f[f.AtImport = 2] = "AtImport", f[f.JsPluginCompat = 4] = "JsPluginCompat", f[f.ThemeFunction = 8] = "ThemeFunction", f[f.Utilities = 16] = "Utilities", f[f.Variants = 32] = "Variants", f))($e || {});
async function si(t, { base: r = "", loadModule: i = Wn, loadStylesheet: e = Bn } = {}) {
    ...
    let s = null, a = new He, f = [], u = [], c = null, g = null, m = [], h = [], v = [], w = [], A = null;
    I(t, (y, { parent: S, replaceWith: E, context: P })=>{
        if (y.kind === "at-rule") {
            if (y.name === "@tailwind" && (y.params === "utilities" || y.params.startsWith("utilities"))) {
                ...
                let _ = K(y.params, " ");
                for (let L of _)if (L.startsWith("source(")) {
                    let R = L.slice(7, -1);
                    if (R === "none") {
                        A = R;
                        continue;
            ...
            if (y.name === "@source") {
                ...
                let _ = !1, L = !1, R = y.params;
                if (R[0] === "n" && R.startsWith("not ") && (_ = !0, R = R.slice(4)), R[0] === "i" && R.startsWith("inline(") && (L = !0, R = R.slice(7, -1)), R[0] === '"' && R[R.length - 1] !== '"' || R[0] === "'" && R[R.length - 1] !== "'" || R[0] !== "'" && R[0] !== '"') throw new Error("`@source` paths must be quoted.");
                let G = R.slice(1, -1);
                if (L) {
                    let z = _ ? w : v, B = K(G, " ");
                    for (let se of B)for (let xe of pt(se))z.push(xe);
                } else h.push({
                    base: P.base,
                    pattern: G,
                    negated: _
            ...
            if (y.name === "@variant" && (S === null ? y.nodes.length === 0 ? y.name = "@custom-variant" : (I(y.nodes, (_)=>{
                ...
                E([]);
                let [_, L] = K(y.params, " ");
                if (!ot.test(_)) throw new Error(`\`@custom-variant ${_}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
                if (y.nodes.length > 0 && L) throw new Error(`\`@custom-variant ${_}\` cannot have both a selector and a body.`);
                if (y.nodes.length === 0) {
                    if (!L) throw new Error(`\`@custom-variant ${_}\` has no selector or body.`);
                    let R = K(L.slice(1, -1), ",");
                    if (R.length === 0 || R.some((B)=>B.trim() === "")) throw new Error(`\`@custom-variant ${_} (${R.join(",")})\` selector is invalid.`);
                    let G = [], z = [];
                    for (let B of R)B = B.trim(), B[0] === "@" ? G.push(B) : z.push(B);
                    f.push((B)=>{
                        B.variants.static(_, (se)=>{
                            let xe = [];
                            z.length > 0 && xe.push(F(z.join(", "), se.nodes));
                            for (let Dt of G)xe.push(M(Dt, se.nodes));
                            se.nodes = xe;
                        }, {
                            compounds: ye([
                                ...z,
            ...
            if (y.name === "@media") {
                let _ = K(y.params, " "), L = [];
                for (let R of _)if (R.startsWith("source(")) {
                    let G = R.slice(7, -1);
                    I(y.nodes, (z, { replaceWith: B })=>{
                        if (z.kind === "at-rule" && z.name === "@tailwind" && z.params === "utilities") return z.params += ` source(${G})`, B([
                            ne({
                                sourceBase: P.base
                            }, [
                                z
                    ...
                    let G = R.slice(6, -1), z = G.includes("reference");
                    I(y.nodes, (B)=>{
                        if (B.kind !== "at-rule") {
                    ...
                    let G = R.slice(7, -1);
                    I(y.nodes, (z)=>{
                        if (z.kind === "at-rule" && z.name === "@theme") return z.params += ` prefix(${G})`, 1;
                    });
                } else R === "important" ? s = !0 : R === "reference" ? y.nodes = [
                    ne({
                        reference: !0
                    }, y.nodes)
                ] : L.push(R);
                L.length > 0 ? y.params = L.join(" ") : _.length > 0 && E(y.nodes);
            }
            if (y.name === "@theme") {
                let [_, L] = qn(y.params);
                if (P.reference && (_ |= 2), L) {
                    if (!Mn.test(L)) throw new Error(`The prefix "${L}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
                    a.prefix = L;
                }
                return I(y.nodes, (R)=>{
                    if (R.kind === "at-rule" && R.name === "@keyframes") return a.addKeyframes(R), 1;
...
${G}`);
    ...
    let b1 = $r(a);
    if (s && (b1.important = s), w.length > 0) for (let y of w)b1.invalidCandidates.add(y);
    n |= await li({
        designSystem: b1,
        base: r,
        ast: t,
    ...
    if (c) {
        let y = [];
        for (let [E, P] of b1.theme.entries())P.options & 2 || y.push(l(ue(E), P.value));
        let S = b1.theme.getKeyframes();
        for (let E of S)t.push(ne({
            theme: !0
        }, [
            D([
                E
    ...
    if (m.length > 0) {
        for (let y of m){
            let S = F("&", y.nodes), E = y.params, P = b1.parseVariant(E);
            if (P === null) throw new Error(`Cannot use \`@variant\` with unknown variant: ${E}`);
            if (Ve(S, P, b1.variants) === null) throw new Error(`Cannot use \`@variant\` with variant: ${E}`);
            Object.assign(y, S);
        }
        n |= 32;
    }
    return n |= Ne(t, b1), n |= Ue(t, b1), I(t, (y, { replaceWith: S })=>{
...
async function ui(t, r = {}) {
    let { designSystem: i, ast: e, sources: n, root: s, utilitiesNode: a, features: f, inlineCandidates: u } = await si(t, r);
    e.unshift(qe(`! tailwindcss v${jt} | MIT License | https://tailwindcss.com `));
    function c(w) {
    ...
    return {
        ...
        build (w) {
            if (f === 0) return t;
            if (!a) return m ??= ve(e, i, r.polyfills), m;
            let A = v, b1 = !1;
            v = !1;
            let y = g.size;
            for (let E of w)if (!i.invalidCandidates.has(E)) if (E[0] === "-" && E[1] === "-") {
                let P = i.theme.markUsedVariable(E);
                A ||= P, b1 ||= P;
            } else g.add(E), A ||= g.size !== y;
            if (!A) return m ??= ve(e, i, r.polyfills), m;
            let S = pe(g, i, {
                onInvalidCandidate: c
            }).astNodes;
            return !b1 && h === S.length ? (m ??= ve(e, i, r.polyfills), m) : (h = S.length, a.nodes = S, m = ve(e, i, r.polyfills), m);
        }
    };
}
async function Hn(t, r = {}) {
    let i = ge(t), e = await ui(i, r), n = i, s = t;
    return {
        ...e,
        build (a) {
            let f = e.build(a);
            return f === n || (s = te(f), n = f), s;
        }
    };
}
async function Gn(t, r = {}) {
    return (await si(ge(t), r)).designSystem;
}
function ze() {
...
for(let t in dt)t !== "default" && (ze[t] = dt[t]);
module.exports = ze;
}}),
